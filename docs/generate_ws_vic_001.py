...
def build_pdf():
    ...
    # Authorized footer (small, unobtrusive)
    ...
    story.append(Paragraph(
        "— End of Document —<br/>"
        "This document was generated by authorized tooling of the Worshipping Sekhmet Framework.<br/>"
        "Licensed under CC BY-NC-ND 4.0. See repository LICENSE for details.",
        footer_style
    ))
